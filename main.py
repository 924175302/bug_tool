...
def bugtool():
    ...
    variables = {"first": 50, "last": 50, "jql": "project = \"DX\" AND type = Bug AND \"Epic Link\" = DX-4 ORDER BY created DESC", "amountOfIds": 1000, "isMaxResultsLimitEnabled": True}
    ...
    send = requests.post('https://open.feishu.cn/open-apis/bot/v2/hook/1fec7d6d-3101-4d14-b053-de5f703d14ea',json.dumps(p))

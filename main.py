...
def bugtool():
    ...
    variables = {"first": 50, "last": 50, "jql": "project = \"DX\" AND type = Bug AND \"Epic Link\" = DX-1 ORDER BY created DESC", "amountOfIds": 1000, "isMaxResultsLimitEnabled": True}
    ...
    send = requests.post('https://open.feishu.cn/open-apis/bot/v2/hook/ffb7c1b3-97d5-4f82-bcef-cc6b70bf30b6',json.dumps(p))
